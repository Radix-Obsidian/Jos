...
# Auto-populate from environment variables (VOICE_<name>=<id>)
for _key, _val in os.environ.items():
    if _key.startswith('VOICE_') and _key != 'VOICE_':
        VOICES[_key[6:].lower()] = (_val, "eleven_multilingual_v2", {"stability": 0.5, "similarity_boost": 0.75, "style": 0.3})
